<template>
  <q-page class="flex flex-center">
    ...
    <q-btn @click="goRoute('Test')">Tester</q-btn>
  </q-page>
</template>
...
export default defineComponent({
  ...
  methods: {
    goRoute(route) {
      switch (route) {
        case 'SourceData':
          this.$router.push("builders/DataSource")
          break;
        case 'Question':
          this.$router.push("builders/Question")
          break;
        case 'Indicator':
          this.$router.push("builders/Indicator")
          break;
        case 'Document':
          this.$router.push("builders/Document")
          break;
        case 'Test':
          this.$router.push("builders/Test")
          break;
      }
    }
  }
